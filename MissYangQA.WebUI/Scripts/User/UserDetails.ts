    ...
    class UserDetailsPage {
        ...
        private BindMode() {
            ...
            if (!MTMa.IsNullOrUndefinedOrEmpty(UserDetailsPage.PageData.params["ID"])) {
                ...
                UserDetailsPage.PageData.url = "api/User/EditUserInfo";
                ...
                UserDetailsPage.PageData.url = "api/User/AddUserInfo";
        ...
        private BtnSaveEvent_Click(e: MouseEvent) {
            ...
            if (!MTMa.IsNullOrUndefined(data)) {
                ...
                common.SendPostAjax(UserDetailsPage.PageData.url, data, SFun, FFun, CFun);
            }
        }
        /**
         * 获得输入数据
