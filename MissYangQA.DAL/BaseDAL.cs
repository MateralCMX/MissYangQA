...
namespace MissYangQA.DAL
{
    public class BaseDAL<TModel, VModel> : BaseDAL<TModel> where TModel : class where VModel : class
    {
        ...
        public VModel GetDBModelViewInfoByID(object id)
        {
            ...
            if (modelPro != null)
            {
                ...
                {
                    Guid ID = Guid.Parse(id as string);
        ...
        {
            PropertyInfo dbPro = typeof(VModel).GetProperty(typeof(VModel).Name);
            if (dbPro != null)
            {
    ...
    public class BaseDAL<T> : BaseDAL where T : class
    {
        ...
        {
            PropertyInfo dbPro = typeof(T).GetProperty(typeof(T).Name);
            if (dbPro != null)
            {
    ...
    public class BaseDAL
    {
        ...
        /// 数据连接对象
        /// </summary>
        protected readonly MissYangQADBEntities _DB = new MissYangQADBEntities();
        /// <summary>
        /// 主键名称
        /// </summary>
